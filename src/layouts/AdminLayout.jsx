...
const AdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F3]">
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-[260px] bg-white border-r border-[#EBEBEB] transform transition-transform duration-300 lg:translate-x-0 ${
      ...
      >
        ...
        <nav className="p-4 space-y-1 overflow-y-auto h-[calc(100vh-72px)]">
            ...
            <Link
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl text-[14px] font-medium transition-all duration-200 ${
                isActive(item.path)
                  ...
                  : 'text-[#6B6B6B] hover:bg-[#F5F5F3] hover:text-[#2D2D2D]'
              }`}
            >
              {item.icon}
              {item.label}
          ...
          <div className="pt-4 mt-4 border-t border-[#EBEBEB]">
            <Link
              to="/"
              className="flex items-center gap-3 px-4 py-3 rounded-xl text-[14px] font-medium text-[#6B6B6B] hover:bg-[#F5F5F3] hover:text-[#2D2D2D] transition-all duration-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="lg:pl-[260px]">
        <header className="sticky top-0 z-30 h-[72px] bg-white/95 backdrop-blur-md border-b border-[#EBEBEB]">
          <div className="flex items-center justify-between h-full px-6">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                ...
                <p className="text-[12px] text-[#6B6B6B]">Quản trị viên</p>
              </div>
              <button
                onClick={handleLogout}
                className="p-2.5 text-[#6B6B6B] hover:text-[#C45C4A] hover:bg-[#FEF2F2] rounded-xl transition-all duration-200"
                title="Đăng xuất"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
