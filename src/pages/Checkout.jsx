          ...
          <div className="bg-white rounded-2xl border border-[#EBEBEB] p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.fullName && (
                  <p className="text-[12px] text-[#C45C4A] mt-1">
                    {errors.fullName}
                  </p>
                )}
              </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[13px] text-[#2D2D2D] line-clamp-2">
                        {item.product.name}
                      </p>
                      {item.variantName && (
            ...
            <div className="border-t border-[#EBEBEB] pt-5 space-y-4">
              {appliedPromo ? (
                ...
                <div>
                  ...
                  {promoError && (
                    <p className="text-[12px] text-[#C45C4A] mt-2">
                      {promoError}
                    </p>
                  )}
                </div>
              ...
              <div className="space-y-3 text-[14px]">
                ...
                <div className="flex justify-between">
                  ...
                  <span
                    className={
                      shippingFee === 0 ? "text-[#7C9A82]" : "text-[#2D2D2D]"
                    }
                  >
